...
clean_data02['TEMP'].replace(0, clean_data02['TEMP'].mean(), inplace=True)
clean_data02['WS'].replace(0, clean_data02['WS'].mean().round(), inplace=True)

clean_data02 = clean_data02.drop(index=range(1392, len(clean_data02)))
clean_data03 = clean_data02.drop(['Unnamed: 0'], axis=1, inplace=True)
...
clean_data02.to_csv("C:\\Users\\ASUS\\Desktop\\VS code\\PsuTerm02\\241-152\\final_project\\data_mange\\clean03_air4thai_44t_2023-01-01_2024-02-27.csv", index=False)
